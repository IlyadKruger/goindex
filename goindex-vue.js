self.props = {
  ...
  // https://github.com/IlyadKruger/goindex/tree/production/themes
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_goindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/IlyadKruger/goindex/production/themes/material-vue-${self.props.ui}/${remain}`);
