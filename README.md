...
<img src="https://img.shields.io/github/last-commit/IlyadKruger/goindex.svg?logo=Sublime+Text&logoColor=green&label=Active"/>
<img alt="GitHub Release Date" src="https://img.shields.io/github/release-date/IlyadKruger/goindex">
<img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/IlyadKruger/goindex">
<img alt="goindex-softwareheritage.org" src="https://archive.softwareheritage.org/badge/origin/https://github.com/Unipisa/CMM/"/>
<img alt="GitHub repo size" src="https://img.shields.io/github/repo-size/IlyadKruger/goindex">
<img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FIlyadKruger%2Fgoindex&count_bg=%2379C83D&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=Views&edge_flat=false"/>
...
Worker Script (Dark Mode) : [index.js](https://raw.githubusercontent.com/IlyadKruger/goindex/master/goindex-acrou/go2index/index.js)

Worker Script (Multiple Google Accounts) : [index-multiple-accounts.js](https://raw.githubusercontent.com/IlyadKruger/goindex/master/goindex-acrou/go2index/index-multiple-accounts.js)

Demo - [goindex.teamsdrives.workers.dev](https://goindex.teamsdrives.workers.dev)

Copy the [index.js](https://raw.githubusercontent.com/IlyadKruger/goindex/master/goindex-acrou/go2index/index.js) script to [workers.dev](https://workers.cloudflare.com/) and edit `client_id`, `client_secret`, `refresh_token` with yours
...
---
Worker Script - [index.js](https://github.com/IlyadKruger/goindex/blob/2.0.8-darkmode-0.1/goindex-vue.js)
...
Workers Script - [index.js](https://github.com/IlyadKruger/goindex/blob/2.0.8-darkmode-0.1/goindex.js)
...
```
src="//cdn.jsdelivr.net/combine/gh/jquery/jquery/dist/jquery.min.js,gh/IlyadKruger/goindex@${authConfig.hash}/themes/${authConfig.theme}/app.js"
```
